...
conj_subordinating_sentences = [
  "I am really proud of my group because we're always discussing and sharing study secrets together. How important the group work is!",
  "- Are you going camping this afternoon? - A typhoon is coming. I'm not sure whether the road to the mountains will be closed.",
  "- How do you like the concert given by EXO? - Exciting, though one piece of the music wasn't played quite well.",
  ...
  "I'd like to go with you, but I'm too busy.",
  "- I think everyone should play a part in saving our environment. - I agree. For example, there will be less air pollution if we drive less.",
]
...
conj_coordinating_sentences = [
  ...
  "He is only ten months old. He can neither read nor write.",
  ...
  "- Which would you like better, tea or milk? - Tea, please.",
  "She said she might come either Saturday or Sunday.",
  "Both Tom and Peter are found of watching TV.",
  "- Where are you going to stay when you get to Shanghai? - I may live either in a hotel or in a friend's house.",
]
