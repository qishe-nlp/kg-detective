...
def search_out(doc, nlp):
  ...
  dep_patterns = [
    [
      ...
      },
      {
        ...
        "REL_OP": ">",
        "RIGHT_ID": "pron",
        "RIGHT_ATTRS": {"DEP": {"IN": ["oa", "da"]}, "MORPH": {"IS_SUPERSET": ["PronType=Prs", "Reflex=Yes"]}}
      },
    ],
  ]
  dep_matcher.add("pron_reflexive", dep_patterns)
  ...
  for _, (verb, pron) in matches:
    ...
    svp_token_ids = [e.i for e in verb_token.children if e.dep_ == "svp" and e.pos_ == "ADP"]
    span_ids.extend(svp_token_ids)
