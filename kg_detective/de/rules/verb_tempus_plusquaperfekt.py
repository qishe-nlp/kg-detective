...
def search_out(doc, nlp):
  ...
  dep_patterns = [
    [
      {
        "RIGHT_ID": "aux",
        "RIGHT_ATTRS": {"POS": "AUX", "TAG": "VAFIN", "LEMMA": {"IN": ["haben", "Haben", "Sein", "sein"]}, "MORPH": {"IS_SUPERSET": ["Tense=Past", "Mood=Ind"]}}
      },
      {
        "LEFT_ID": "aux",
        "REL_OP": ">",
  ...
  dep_matcher.add("verb_tempus_plusquaperfekt", dep_patterns)
