...
LABELS = ["NOUN", "ART", "VERB", "ADJ", "PREP", "PRON", "ADV", "NUM", "CONJ", "INTERJ"]
...
VERB_RULES = ["verb_indicativo_presente", "verb_indicativo_preterito", "verb_indicativo_preterito_perfecto", "verb_indicativo_preterito_imperfecto", "verb_indicativo_preterito_pluscuamperfecto", "verb_indicativo_futuro", "verb_indicativo_futuro_perfecto", "verb_condicional_simple", "verb_condicional_compuesto", "verb_subjuntivo_presente", "verb_subjuntivo_preterito_perfecto", "verb_subjuntivo_preterito_imperfecto", "verb_subjuntivo_preterito_pluscuamperfecto", "verb_imperativo_regulares", "verb_imperativo_irregulares", "verb_imperativo_con_pron", "verb_voz_pasiva", "verb_infinitivo", "verb_participio", "verb_gerundio", "verb_oraciones_impersonales", "verb_reflexivos"]

ADJ_RULES = ["adj_posesivos", "adj_demostrativos", "adj_indefinidos", "adj_género_y_número", "adj_comparativa", "adj_superlativa"]

PREP_RULES = ["prep_con_verbo", "prep_adjetivo"]
