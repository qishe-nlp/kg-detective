...
def search_out(doc, nlp):
  ...
  rule_name = "verb_indicativo_pretérito"
  ...
  verb = [
    {
      "RIGHT_ID": "verb",
      "RIGHT_ATTRS": {"POS": "VERB", "DEP": "ROOT", "MORPH": {"IS_SUPERSET": ["Mood=Ind", "Tense=Past"]}}
    }
  ]
  ...
  ser_verb = [
    ...
    },
    {
      ...
      "REL_OP": ">--",
      "RIGHT_ID": "aux",
      "RIGHT_ATTRS": {"POS": "AUX", "LEMMA": "ser", "MORPH": {"IS_SUPERSET": ["Mood=Ind", "Tense=Past"]}}
    }
  ]
