...
def search_out(doc, nlp):
  ...
  haber_ser_verb = [
    ...
    },
    {
      ...
      "REL_OP": ">--",
      "RIGHT_ID": "haber",
      "RIGHT_ATTRS": {"POS": "AUX", "DEP": "aux", "LEMMA": {"IN": ["habrías", "haber"]}, "MORPH": {"IS_SUPERSET": ["Mood=Cnd"]}}
    }
  ]
  ...
  haber_verb = [
    {
      "RIGHT_ID": "verb",
      "RIGHT_ATTRS": {"POS": {"IN": ["AUX", "VERB"]}, "MORPH": {"IS_SUPERSET": ["Tense=Past", "VerbForm=Part"]}}
    },
    {
      "LEFT_ID": "verb",
      "REL_OP": ">--",
      "RIGHT_ID": "aux",
      "RIGHT_ATTRS": {"POS": "AUX", "DEP": "aux", "LEMMA": {"IN": ["haber", "habrías"]}, "MORPH": {"IS_SUPERSET": ["Mood=Cnd"]}}
    }
  ]
